...
namespace DataFactory.BaseFactory
{
    public interface IGenericFactoryOracle<T> where T : class
    {
        ...
        Task<string> ExecuteCommandStrings(string spQuery, OracleCommand ocmd, string conString);
        Task<string> ExecuteDataTableToJSON(string spQuery, OracleCommand cmd, string conString);
        Task<string> ExecuteDataTableToJSON(string spQuery, Hashtable ht, string conString);
