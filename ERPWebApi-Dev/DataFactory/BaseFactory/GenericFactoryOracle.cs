...
namespace DataFactory.BaseFactory
{
    public class GenericFactoryOracle<T> : IGenericFactoryOracle<T> where T : class, new()
    {
            ...
            return Task.Run(() =>
            {
                ...
                try
                {
                    using (OracleConnection con = new OracleConnection(conString))
                    {
                        ...
                        if (dr.Read())
                        {
                            result = dr.IsDBNull(0) ? string.Empty : Convert.ToString(dr.GetString(0));
                        }
        ...
        public Task<string> ExecuteCommandStrings(string spQuery, OracleCommand cmd, string conString)
        {
            return Task.Run(() =>
            {
                string result = string.Empty;
        ...
        public Task<string> ExecuteDataTableToJSON(string spQuery, OracleCommand cmd, string conString)
        {
            return Task.Run(() =>
            {
                string result = string.Empty;
        ...
        public Task<string> ExecuteDataTableToJSON(string spQuery, Hashtable ht, string conString)
        {
            return Task.Run(() =>
            {
                string result = string.Empty;
                try
                {
                    ...
                    using (OracleConnection con = new OracleConnection(conString))
                    {
                        ...
                        spQuery = MapQueryParameter(spQuery, ht);
                        cmd.CommandText = spQuery;
        ...
        private string DataTableMapToJson(DataTable dataTable)
        {
