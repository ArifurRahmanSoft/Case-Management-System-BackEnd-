...
namespace CTG_ERPWebApi.api.common.menus
{
    ...
    public class menuController : ControllerBase
    {
        ...
        private MenuMgt _manager = null;
        #endregion

        #region Constructor
        public menuController()
        {
            _manager = new MenuMgt();
        }
        #endregion
        ...
        // GET: api/menu/getparentmenu
        [HttpGet("[action]")]//, BasicAuthorization
        public async Task<object> getparentmenu([FromQuery] string param)
        {
            object result = null; object resdata = null;
            try
            {
                ...
                vmCmnParameter cmnParam = JsonConvert.DeserializeObject<vmCmnParameter>(data[0].ToString());
                //resdata = await _manager.GetParentMenu();
                resdata = await _manager.GetParentAndSubParentMenu(cmnParam);
            }
            catch (Exception) { }
            return result = new
            {
        ...
        //// POST: api/menu/saveupdatepermission
        //[HttpPost("[action]")]//, BasicAuthorization
        ...
        //        if (mstr != null)
        //        {
        //            resdata = await _manager.SaveUpdatePermission(mstr, param);
        //        }
        //    }
        //    catch (Exception) { }
        //    return result = new
