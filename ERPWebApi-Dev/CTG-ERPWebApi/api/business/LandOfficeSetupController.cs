...
namespace CTG_ERPWebApi.api.business
{
    ...
    [ApiController]
    public class landOfficeSetupController : ControllerBase
    {

        #region Variable Declaration & Initialization
        private LandOfficeSetupMgt _manager = null;
        #endregion

        #region Constructor
        public landOfficeSetupController()
        {
            _manager = new LandOfficeSetupMgt();
        }
        #endregion
