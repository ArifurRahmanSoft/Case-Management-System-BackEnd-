...
namespace DataUtilities
{
    public static class StaticInfos
    {
        ...
        public const String conStringOracle = @"Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=erpprd)(PORT=1523))(CONNECT_DATA=(SERVICE_NAME=CITYNPDB)));User Id=city_lms;Password=citylms_it;Persist Security Info=True";
        //public const String conStringOracle = @"Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=erp-standby)(PORT=1528))(CONNECT_DATA=(SERVICE_NAME=MEDIAPDB)));User Id=city_media;Password=citymedia.it;Persist Security Info=True";
